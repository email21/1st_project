...
@dataclass
class FinlifeConfig:
    """금융감독원 금융상품한눈에 API 설정 클래스"""
    API_URLS = {
        'company': 'http://finlife.fss.or.kr/finlifeapi/companySearch.json', # prdt_div == 'F'
        ...
        'annuity': 'http://finlife.fss.or.kr/finlifeapi/annuitySavingProductsSearch.json', # prdt_div == 'P'
...
class FinlifeDataCollector:
    ...
    def _setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('./logs/finlife_collector.log', encoding='utf-8'),
